<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<style>
		...
		<link href="/111/themes/simplebootx/Public/css/slippry/slippry.css" rel="stylesheet">
		<style>
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/111/themes/simplebootx/Public/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
...
<script src="/111/themes/simplebootx/Public/js/slippry.min.js"></script>
<script>
$(function() {
