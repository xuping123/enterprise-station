<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
    ...
    <![endif]-->
	<link rel="icon" href="/111/themes/simplebootx/Public/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/111/themes/simplebootx/Public/images/favicon.ico" type="image/x-icon">
    <link href="/111/themes/simplebootx/Public/simpleboot/themes/simplebootx/theme.min.css" rel="stylesheet">
    <link href="/111/themes/simplebootx/Public/simpleboot/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="/111/themes/simplebootx/Public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
	<!--[if IE 7]>
	<link rel="stylesheet" href="/111/themes/simplebootx/Public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
	<link href="/111/themes/simplebootx/Public/css/style.css" rel="stylesheet">
	<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/111/"><img src="/111/themes/simplebootx/Public/images/logo.png"/></a>
 ...
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
		...
		<ul class="nav pull-right" id="main-menu-user">
			<li class="dropdown user login">
	            ...
	            <img src="/111/themes/simplebootx//Public/images/headicon.png" class="headicon"/>
          	...
          	<li class="dropdown user offline">
	            <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
	           		<img src="/111/themes/simplebootx//Public/images/headicon.png" class="headicon"/>登录<b class="caret"></b>
	            </a>
	            <ul class="dropdown-menu pull-right">
			...
			<div class="tc-box first-box article-box">
		    	...
		    	<div class="article-infobox">
		    		...
		    		<span>
						...
						<a href="<?php echo U('user/favorite/do_favorite',array('id'=>$object_id));?>" class="js-favorite-btn" data-title="<?php echo ($post_title); ?>" data-url="<?php echo U('article/index',array('id'=>$tid));?>" data-key="<?php echo sp_get_favorite_key('posts',$object_id);?>">
		    	...
		    	<div>
    	            ...
    	            <script type="text/javascript" src="/111/themes/simplebootx/Public/js/qrcode.min.js"></script>
			...
			<div class="tc-box">
	        	...
	        	<div class="comment-ranking">
	        		...
	        		<?php if(is_array($last_comments)): foreach($last_comments as $key=>$vo): ?><div class="comment-ranking-inner">
	                        ...
	                        <a href="/111/<?php echo ($vo["url"]); ?>#comment<?php echo ($vo["id"]); ?>">查看原文</a>
...
<!-- Le javascript
    ...
    <script src="/111/public/js/wind.js"></script>
    <script src="/111/themes/simplebootx/Public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
    <script src="/111/public/js/frontend.js"></script>
	<script>
	$(function(){
		...
		$.post("<?php echo U('user/index/is_login');?>",{},function(data){
			if(data.status==1){
				if(data.user.avatar){
					$("#main-menu-user .headicon").attr("src",data.user.avatar.indexOf("http")==0?data.user.avatar:"/111/data/upload/avatar/"+data.user.avatar);
				}
